...
public class FacesContextHelper {
	...
	public static void cleanFacesMessages(FacesContext facesContext, String clientId) {
	...
	public static void cleanImmediateFacesMessages(FacesContext facesContext) {
		cleanImmediateFacesMessages(facesContext, facesContext.getViewRoot());
	}

	public static void cleanImmediateFacesMessages(FacesContext facesContext, UIComponent uiComponent) {
		if (uiComponent instanceof ActionSource) {
			ActionSource actionSource = (ActionSource) uiComponent;
			if (actionSource.isImmediate()) {
				cleanFacesMessages(facesContext, uiComponent.getClientId(facesContext));
			}
		...
		for (UIComponent childComponent : childComponents) {
			cleanImmediateFacesMessages(facesContext, childComponent);
		}
	}
}
